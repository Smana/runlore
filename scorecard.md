...
**Latest run:** 2026-08-25T06:59:22Z · model `openai/glm-4.5-air` · **1/6 scenarios reached (17%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.30 (1.2M in / 53.2k out tokens)
...
| harbor-chart-bump | ⚠️ FLAKY | 40% (n=5) | 0.90 | — | harbor-db, migration |
| node-eviction-no-commons | ⚠️ FLAKY | 40% (n=5) | 0.70 | fired 0/5 · short-circuit 0/5 (expect: rejected) | request |
| node-eviction-with-commons | ⚠️ FLAKY | 60% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | report-worker, request |
| poisoned-recall-rejected | ⚠️ FLAKY | 40% (n=5) | 0.90 | — | eval-victim, pull |
| poisoned-recall-verify | ❌ MISS | 0% (n=5) | 0.95 | fired 5/5 · short-circuit 0/5 (expect: withdrawn) | eval-victim, expect_recall=withdrawn but recall verify_unavailable, v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 37.5k | 1.5k | $0.009 |

## Confidence calibration

- **Confidently wrong** (missed with median confidence ≥ 0.70): 5 — harbor-chart-bump, node-eviction-no-commons, node-eviction-with-commons, poisoned-recall-rejected, poisoned-recall-verify
