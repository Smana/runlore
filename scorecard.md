...
**Latest run:** 2026-08-21T07:04:23Z · model `openai/glm-4.5-air` · **2/6 scenarios reached (33%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.28 (1.1M in / 54.6k out tokens)
...
| node-eviction-no-commons | ⚠️ FLAKY | 40% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | request |
| node-eviction-with-commons | ✅ PASS | 80% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | report-worker, request |
| poisoned-recall-rejected | ⚠️ FLAKY | 40% (n=5) | 0.80 | — | eval-victim, pull, v9.9.9 |
| poisoned-recall-verify | ❌ MISS | 20% (n=5) | 0.95 | fired 5/5 · short-circuit 0/5 (expect: withdrawn) | v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 31.1k | 1.8k | $0.008 |
