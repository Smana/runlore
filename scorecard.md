...
**Latest run:** 2026-09-23T10:54:28Z · model `openai/glm-4.5-air` · **5/6 scenarios reached (83%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.31 (1.2M in / 58.5k out tokens)
...
|---|---|---|---|---|
| full investigation | 6 | 33.9k | 1.9k | $0.009 |

## Confidence calibration

- **Confidently wrong** (missed with median confidence ≥ 0.70): 1 — node-eviction-no-commons
