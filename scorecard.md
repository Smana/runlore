...
**Latest run:** 2026-09-14T11:49:15Z · model `openai/glm-4.5-air` · **3/6 scenarios reached (50%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.27 (1.0M in / 55.2k out tokens)
...
| poisoned-recall-rejected | ✅ PASS | 80% (n=5) | 0.90 | — | v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 33.8k | 2.0k | $0.009 |
