...
**Latest run:** 2026-08-29T12:25:38Z · model `openai/glm-4.5-air` · **3/6 scenarios reached (50%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.32 (1.3M in / 54.7k out tokens)
...
| node-eviction-no-commons | ❌ MISS | 20% (n=5) | 0.75 | fired 0/5 · short-circuit 0/5 (expect: rejected) | report-worker, request |
| node-eviction-with-commons | ✅ PASS | 100% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | — |
| poisoned-recall-rejected | ⚠️ FLAKY | 60% (n=5) | 0.90 | — | eval-victim, pull, v9.9.9 |
| poisoned-recall-verify | ✅ PASS | 80% (n=5) | 1.00 | fired 5/5 · short-circuit 0/5 (expect: withdrawn) | v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 33.3k | 1.8k | $0.009 |

## Confidence calibration

- **Confidently wrong** (missed with median confidence ≥ 0.70): 3 — harbor-chart-bump, node-eviction-no-commons, poisoned-recall-rejected
