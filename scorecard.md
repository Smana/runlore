...
**Latest run:** 2026-08-30T11:21:46Z · model `openai/glm-4.5-air` · **2/6 scenarios reached (33%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.30 (1.2M in / 59.1k out tokens)
...
| node-eviction-no-commons | ⚠️ FLAKY | 60% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | request |
| node-eviction-with-commons | ✅ PASS | 80% (n=5) | 0.85 | fired 0/5 · short-circuit 0/5 (expect: rejected) | report-worker, request |
| poisoned-recall-rejected | ⚠️ FLAKY | 40% (n=5) | 0.90 | — | v9.9.9 |
| poisoned-recall-verify | ⚠️ FLAKY | 60% (n=5) | 0.95 | fired 5/5 · short-circuit 0/5 (expect: withdrawn) | v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 36.8k | 2.0k | $0.010 |
