...
**Latest run:** 2026-08-19T06:58:02Z · model `openai/glm-4.5-air` · **3/6 scenarios reached (50%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.28 (1.1M in / 59.1k out tokens)
...
| node-eviction-no-commons | ❌ MISS | 20% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | report-worker, request |
| node-eviction-with-commons | ✅ PASS | 80% (n=5) | 0.80 | fired 0/5 · short-circuit 0/5 (expect: rejected) | request |
...
|---|---|---|---|---|
| full investigation | 6 | 25.3k | 1.7k | $0.007 |
