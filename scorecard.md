...
**Latest run:** 2026-08-18T06:58:03Z · model `openai/glm-4.5-air` · **2/6 scenarios reached (33%)** · n=5 runs/case, k-of-n bar 70% · est. cost $0.31 (1.2M in / 54.0k out tokens)
...
| node-eviction-no-commons | ❌ MISS | 0% (n=5) | 0.90 | fired 0/5 · short-circuit 0/5 (expect: rejected) | request |
...
| poisoned-recall-verify | ⚠️ FLAKY | 40% (n=5) | 0.95 | fired 5/5 · short-circuit 0/5 (expect: withdrawn) | eval-victim, expect_recall=withdrawn but recall verify_unavailable, pull, v9.9.9 |
...
|---|---|---|---|---|
| full investigation | 6 | 30.1k | 1.8k | $0.008 |
